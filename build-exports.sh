...
echo "🔨 Building Lua WASM with Direct Function Exports"
echo ""

mkdir -p .build web

echo "🔧 Step 1: Compile Lua C sources (without WASI)"
cd src/lua
...
echo ""
echo "🔧 Step 2: Create WASM module with exported functions (no WASI runtime)"
zig build-exe \
